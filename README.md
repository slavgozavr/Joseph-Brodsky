...
<head>
    ...
    <title>Стихотворения Иосифа Бродского</title>
    <style>
        body {
...
<!-- Также добавьте эти элементы для навигации и социальных функций перед закрывающим тегом </body> -->
...
<!-- Не забудьте вставить этот JavaScript-код перед закрывающим тегом </body> -->
